...
import io.rheem.api.graph.{Edge, EdgeDataQuantaBuilder, EdgeDataQuantaBuilderDecorator}
import io.rheem.api.util.{DataQuantaBuilderCache, TypeTrap}
import io.rheem.basic.data.{Record, Tuple2 => RT2}
import io.rheem.basic.operators.{GlobalReduceOperator, LocalCallbackSink, MapOperator, SampleOperator}
import io.rheem.core.function.FunctionDescriptor.{SerializableBiFunction, SerializableBinaryOperator, SerializableFunction, SerializablePredicate}
...
import io.rheem.core.optimizer.costs.{LoadEstimator, LoadProfile, LoadProfileEstimator}
import io.rheem.core.plan.rheemplan.{Operator, OutputSlot, RheemPlan, UnarySource}
import io.rheem.core.platform.Platform
import io.rheem.core.types.DataSetType
import io.rheem.core.util.{Logging, ReflectionUtils, RheemCollections, Tuple => RheemTuple}
...
trait DataQuantaBuilder[+This <: DataQuantaBuilder[_, Out], Out] extends Logging {
  ...
  /**
    * Set a name for the [[DataQuanta]] and its associated [[io.rheem.core.plan.rheemplan.Operator]]s.
    *
    * @param name the name
  ...
  /**
    * Set an [[Experiment]] for the currently built [[io.rheem.core.api.Job]].
    *
  ...
  /**
    * Register the JAR file containing the given [[Class]] with the currently built [[io.rheem.core.api.Job]].
    *
    * @param cls the [[Class]]
    * @return this instance
    */
  ...
  /**
    * Register a JAR file with the currently built [[io.rheem.core.api.Job]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[MapOperator]] with a [[io.rheem.basic.function.ProjectionDescriptor]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.FilterOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.FlatMapOperator]].
    *
    * @param udf the UDF for the [[io.rheem.basic.operators.FlatMapOperator]]
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.MapPartitionsOperator]].
    *
    * @param udf the UDF for the [[io.rheem.basic.operators.MapPartitionsOperator]]
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.SampleOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.ReduceByOperator]].
    *
    * @param keyUdf the key UDF for the [[io.rheem.basic.operators.ReduceByOperator]]
    * @param udf    the UDF for the [[io.rheem.basic.operators.ReduceByOperator]]
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.MaterializedGroupByOperator]].
    *
    * @param keyUdf the key UDF for the [[io.rheem.basic.operators.MaterializedGroupByOperator]]
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.GlobalMaterializedGroupOperator]].
    *
  ...
  /**
    ...
    * [[io.rheem.basic.operators.UnionAllOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] of this and the given instance into a
    * [[io.rheem.basic.operators.IntersectOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] of this and the given instance into a
    * [[io.rheem.basic.operators.JoinOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] of this and the given instance into a
    * [[io.rheem.basic.operators.CoGroupOperator]].
    *
    * @param thisKeyUdf the key extraction UDF for this instance
    * @param that       the other [[DataQuantaBuilder]] to join with
    * @param thatKeyUdf the key extraction UDF for `that` instance
  ...
  /**
    * Feed the built [[DataQuanta]] of this and the given instance into a
    * [[io.rheem.basic.operators.SortOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] of this and the given instance into a
    * [[io.rheem.basic.operators.CartesianOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.ZipWithIdOperator]].
    *
    * @return a [[ZipWithIdDataQuantaBuilder]] representing the [[io.rheem.basic.operators.ZipWithIdOperator]]'s output
    */
  def zipWithId = new ZipWithIdDataQuantaBuilder(this)

  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.DistinctOperator]].
    *
    * @return a [[DistinctDataQuantaBuilder]] representing the [[io.rheem.basic.operators.DistinctOperator]]'s output
    */
  def distinct = new DistinctDataQuantaBuilder(this)

  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.CountOperator]].
    *
    * @return a [[CountDataQuantaBuilder]] representing the [[io.rheem.basic.operators.CountOperator]]'s output
    */
  def count = new CountDataQuantaBuilder(this)

  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.DoWhileOperator]].
    *
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.RepeatOperator]].
    *
    * @return a [[DoWhileDataQuantaBuilder]]
    */
  ...
  /**
    * Feed the built [[DataQuanta]] into a custom [[Operator]] with a single [[io.rheem.core.plan.rheemplan.InputSlot]]
  ...
  /**
    * Feed the built [[DataQuanta]] into a [[io.rheem.basic.operators.TextFileSink]]. This triggers
    * execution of the constructed [[RheemPlan]].
    *
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.core.plan.rheemplan.UnarySource]]s.
  *
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.CollectionSource]]s.
  *
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.MapOperator]]s.
  *
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.SortOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param keyUdf             UDF for the [[io.rheem.basic.operators.SortOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.FlatMapOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param udf             UDF for the [[io.rheem.basic.operators.FlatMapOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.MapPartitionsOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param udf             UDF for the [[io.rheem.basic.operators.MapPartitionsOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.SampleOperator]]s.
  *
  * @param inputDataQuanta    [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param sampleSizeFunction the absolute size of the sample as a function of the current iteration number
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.ReduceByOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param udf             UDF for the [[io.rheem.basic.operators.ReduceByOperator]]
  * @param keyUdf          key extraction UDF for the [[io.rheem.basic.operators.ReduceByOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.MaterializedGroupByOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param keyUdf          key extraction UDF for the [[io.rheem.basic.operators.MaterializedGroupByOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.GlobalMaterializedGroupOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.GlobalReduceOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  * @param udf             UDF for the [[io.rheem.basic.operators.GlobalReduceOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.UnionAllOperator]]s.
  *
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.IntersectOperator]]s.
  *
  * @param inputDataQuanta0 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  * @param inputDataQuanta1 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.JoinOperator]]s.
  *
  * @param inputDataQuanta0 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  * @param inputDataQuanta1 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  * @param keyUdf0          first key extraction UDF for the [[io.rheem.basic.operators.JoinOperator]]
  * @param keyUdf1          first key extraction UDF for the [[io.rheem.basic.operators.JoinOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.CoGroupOperator]]s.
  *
  * @param inputDataQuanta0 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  * @param inputDataQuanta1 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  * @param keyUdf0          first key extraction UDF for the [[io.rheem.basic.operators.CoGroupOperator]]
  * @param keyUdf1          first key extraction UDF for the [[io.rheem.basic.operators.CoGroupOperator]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.CartesianOperator]]s.
  *
  * @param inputDataQuanta0 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  * @param inputDataQuanta1 [[DataQuantaBuilder]] for the first input [[DataQuanta]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.ZipWithIdOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.DistinctOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.CountOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
  */
...
/**
  * [[DataQuantaBuilder]] implementation for any [[io.rheem.core.plan.rheemplan.Operator]]s. Does not offer
  * any convenience methods, though.
  *
  * @param operator        the custom [[io.rheem.core.plan.rheemplan.Operator]]
...
/**
  * [[DataQuantaBuilder]] implementation for [[io.rheem.basic.operators.DoWhileOperator]]s.
  *
  * @param inputDataQuanta [[DataQuantaBuilder]] for the input [[DataQuanta]]
...
class DoWhileDataQuantaBuilder[T, ConvOut](inputDataQuanta: DataQuantaBuilder[_, T],
  ...
  /**
    * Set the number of expected iterations for the built [[io.rheem.basic.operators.DoWhileOperator]].
    *
